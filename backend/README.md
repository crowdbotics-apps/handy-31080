...
## Project Structure
    ...
    ├── handy_for_mechanics_31080  # Django project configurations
...
1. Clone this repo and `cd handy_for_mechanics_31080`
...
2. Clone this repo and `cd handy_for_mechanics_31080`
